...
//     function transferFrom(address from, address to, uint _value) external view returns (bool success);
//     function approve(address spender, uint value) external view returns (bool success);
