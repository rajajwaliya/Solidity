...
contract RegulatedToken is ERC20Detailed, ERC20Mintable {
  ...
  constructor(ServiceRegistry _registry, string memory _name, string memory _symbol, uint totalSupply) public ERC20Detailed(_name, _symbol, dec)
  {
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    require (_check(msg.sender, _to, _value));
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    require(_check(_from, _to, _value)); 
  ...
  function _check(address _from, address _to, uint256 _value) public returns (bool) {
